pipeline {
    ...
    stages {
        ...
        stage ('Nexus Upload') {
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'MyWebApp', classifier: '', file: 'MyWebApp/target/MyWebApp.war', type: 'war']], credentialsId: '27f682d6-024e-4544-9311-ae62b8efe81e', groupId: 'com.dept.app', nexusUrl: 'ec2-54-84-254-169.compute-1.amazonaws.com:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-snapshots', version: '1.0-SNAPSHOT'
            }
        }
        
        stage ('Dev Deploy') {
            steps {
                deploy adapters: [tomcat9(credentialsId: 'e0606e7e-5abb-4f3e-8ef9-b5906edda676', path: '', url: 'http://ec2-34-201-65-70.compute-1.amazonaws.com:8080')], contextPath: null, war: '**/*.war'
            }
        }
